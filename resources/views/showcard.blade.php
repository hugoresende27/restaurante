...
-->
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            <li class="scroll-to-section"><a href="{{url('/home')}}#menu">Menu</a></li>
                            <li class="scroll-to-section"><a href="{{url('/home')}}#chefs">Chefs</a></li> 
                            <li class="submenu">
                            ...
                            <li class="scroll-to-section"><a href="{{url('/home')}}#reservation">Contact Us</a></li> 
    ...
    <div class="row ">
        <div class="col-12 text-center p-3 navbar fixed-bottom" style="background-color: orange;"><!--fixed-bottom rodapé sempre no fundo -->
